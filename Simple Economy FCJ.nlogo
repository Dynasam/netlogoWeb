...
;;  ask one-of other turtles with [wealth < 300] [ set wealth wealth + 1 ]
end
...
to-report middle-class
  report (sum [wealth] of turtles) - top-10-pct-wealth - bottom-50-pct-wealth
end
